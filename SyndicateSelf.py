...
cl = LINETCR.LINE()
cl.login(token="EnX57JvyKhHVH8XLJs01.iU0HVzEKkrCM/Lo3vS4Vaq.8iAajQqvh+qC/VMeH1bYTnq8pvJpjo6sXOOCW3E+7c0=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EnbHGDnK5JnesFennLL7./V26Y+84iM0vgub4NBmb1W.a2mZp5OvmkWqiiH94fm7YnIyrJJ6ai3GsgiIfUtjtFg=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EnFggeMn71P3w8RWB7q9.W875+I/d4MpqYaWtTDuNcq.9fGIEQ2S/KYsVmTvCqU1wOrDzMdYTuW+vgWUkg/b2x8=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EnEAfXBGYo1vRWsw6J59.fbMcAjl5m9eOdy9zPiwPkq.T1BUpvNp/7BfxRj81vMilmDHcHlMc/Q0tlhk+ut6Hys=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="Enh2F0qYt00wuAIUFHj4.MkwRahR9ZiUNsJo3ElXL9a.4D3437Z5kKk2zyD9r1gKtzHcEKd3km4fxWP5AaKQK4g=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EnxXYoVRPwYWCc0O8sb0.lhi7kD0Il/p2V3aWteDIma.H6jVXAxa/VTkdG1Nmw6hmdeFtxk1rIN4IGnMK33cKnI=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="Enznl6SldLI6khFM7Swe.+urLDlQgcsoUTdJjm8G2ZG.gw8K1aj6/23tkXh0WVZs1GoZuZDPmkK1O84fEGq5Uv4=")
ki6.loginResult()
...
BOT: S̸͟͞Y̸͟͞N̸͟͞D̸͟͞I̸͟͞C̸͟͞A̸͟͞T̸͟͞E̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞
...
def bot(op):
            ...
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                pass
              	...
              	try:
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Wooy Jangan Buka Kode QR")
                	cl.kickoutFromGroup(op.param1,[op.param2])
                	X = cl.getGroup(op.param1)
                	X.preventJoinByTicket = True
                	cl.updateGroup(X)
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\n" + "Masuk Blacklist Lu njir")
                	wait["blacklist"][op.param2] = True
                	f=codecs.open('st2__b.json','w','utf-8')
                	json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                except:
                	random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Wooy Jangan Buka Kode QR Suee")
                	random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                	X = random.choice(KAC).getGroup(op.param1)
                	X.preventJoinByTicket = True
                	random.choice(KAC).updateGroup(X)
                	random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "\n" + "Daftar Blacklist Lu njirr")
                	wait["blacklist"][op.param2] = True
                	f=codecs.open('st2__b.json','w','utf-8')
                	json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "||Admin S̸͟͞Y̸͟͞N̸͟͞D̸͟͞I̸͟͞C̸͟͞A̸͟͞T̸͟͞E̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞||\n=====================\n"
                  for mi_d in admin:
    ...
    #-------------- copy profile----------
                ...
                if txt[1] == "on":
                    ...
                    if jmlh <= 900:
                        ...
                        cl.sendText(msg.to, "Kelebihan batas :v")
    #-----------------=Selesai=------------------
            elif msg.text in ["@all mid","Fiveall"]:
                msg.contentType = 13
            ...
            ##if msg.from_ in admin:
                ...
                ##cl.sendMessage(msg)
            elif msg.text in ["@ourl","Buka qr","Open qr","Ourl","Open","Buka"]:
              ##if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["1buka qr","1open qr"]:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["2buka qr","2open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["@curl","Tutup qr","Close qr","Curl","Close","Tutup"]:
              #if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = True
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              #if msg.from_ in admin:
                string = msg.text.replace("2rename ","")
                if len(string.decode('utf-8')) <= 20:
...
#-------------------- Protect Mode ------------
            elif msg.text in ["@mode on","Allprotect on","Mode on"]:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["@mode off","Allprotect off","Mode Off"]:
                ...
                if wait["Protectgr"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
#----------------------------------------------
            elif msg.text in ["@protect on","Protect on","protect on"]:
              #if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
                ...
                if wait["contact"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["è‡ªå‹•å�‚åŠ :ã‚ªãƒ³","Join on","@join on","Auto join on","è‡ªå‹•å�ƒåŠ ï¼šé–‹"]:
              #if msg.from_ in admin:
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["è‡ªå‹•å�‚åŠ :ã‚ªãƒ•","Join off","@join off","Auto join off","è‡ªå‹•å�ƒåŠ ï¼šé—œ"]:
              #if msg.from_ in admin:
            ...
            elif msg.text in ["å¼·åˆ¶è‡ªå‹•é€€å‡º:ã‚ªãƒ³","Leave on","@leave on","Auto leave:on","å¼·åˆ¶è‡ªå‹•é€€å‡ºï¼šé–‹"]:
              #if msg.from_ in admin:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
            ...
            elif msg.text in ["å¼·åˆ¶è‡ªå‹•é€€å‡º:ã‚ªãƒ•","Leave off","@leave off","Auto leave:off","å¼·åˆ¶è‡ªå‹•é€€å‡ºï¼šé—œ"]:
              #if msg.from_ in admin:
            ...
            elif msg.text in ["è‡ªå‹•è¿½åŠ :ã‚ªãƒ³","@add on","Add on","Auto add:on","è‡ªå‹•è¿½åŠ ï¼šé–‹"]:
              #if msg.from_ in admin:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              #if msg.from_ in admin:
                cl.sendText(msg.to, "Lagi Mau Cyduk Tukang Ngintip Nih")
                try:
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Kampreet Lu||%s\n||By : A⃜ C⃜H⃜I⃜Q⃜A⃜L⃜ F⃜V⃜||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Dulu @cek Cong\nBaru Ketik @ciduk\nJAMBAN LU ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["@syn","Join all","Fivers"]:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["@synoff","Keluar","Kabur"]:
              #if msg.from_ in admin:
                if msg.toType == 2:
                  cl.getGroup(msg.to)
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    cl.sendText(msg.to,"Haaayyyy")
                    cl.sendText(msg.to,"Syndicate and Team Mau Bersih² Group Sampah Nih")
...
#------------------------End---------------------
 ...
 #-----------------End-----------
                ...
                ki.sendText(msg.to,"Manggil kita ???")
                ki2.sendText(msg.to,"Jangan perintah kami !!")
                ki3.sendText(msg.to,"Kalau mau merintah bikin bot sendiri")

#-----------------------------------------------
            elif msg.text in ["Hallo"]:
                ki.sendText(msg.to,"Hallooo juga kakak")
                ki2.sendText(msg.to,"Jangan Nakal ya")
                ki3.sendText(msg.to,"Perintah kami hanya untuk owner A ChiqaLFV")
            elif msg.text in ["Oy"]:
                ki.sendText(msg.to,"jαngαn mєчαkínkαn dírí вαhwα dчα mєnчukαímu hαnчα kαrnα dчα вєrѕíkαp mαníѕ kєpαdαmu, kαrєnα kαdαng kαmu hαnчαlαh ѕєвuαh pílíhαn kєtíkα dчα вσѕαn.")
                ki2.sendText(msg.to,"աƘաƘաƘաƘաƘաƘ")
                ki3.sendText(msg.to,"Nangis dah lu")
            elif msg.text in ["Tes"]:
                ki.sendText(msg.to,"Mau tau Keyward kita ?????")
                ki2.sendText(msg.to,"Bikin Dong BOT sendiri")
                ki3.sendText(msg.to,"Kagak Modal lu")
            elif msg.text in ["Hai fam"]:
                ki.sendText(msg.to,"Aku juga ikutan hai ah")
                ki2.sendText(msg.to,"Aku juga ikutan ah")
                ki3.sendText(msg.to,"Aku juga ikutan Biar gk sepi")
            elif msg.text in ["Welcome"]:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","@resp","Absen bot","Absen dulu","@respon"]:
              #if msg.from_ in admin:
                cl.sendText(msg.to,"Please All Syndicate Respons")
                ki.sendText(msg.to,"rϵαδϒ ϴͷ✔️")
                ki2.sendText(msg.to,"rϵαδϒ ϴͷ✔️")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
                ...
                start = time.time()
                cl.sendText(msg.to, "ͼhϵͼkῖͷg sϼϵϵδ...")
      ...
      #-------------Fungsi Banned Send Contact Start------------------#
                ...
                cl.sendText(msg.to,"sϵͷδ ͼϴͷtαͼt ϼlϵαsϵ")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
            elif msg.text in ["@creat"]:
              msg.contentType = 13
              msg.contentMetadata = {'mid': mid}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu sih Gua cong")
    ...
    for zx in range(0,50):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ᴬᵁᵀᴼ ᴸᴵᴷᴱ by: A⃜ C⃜H⃜I⃜Q⃜A⃜L⃜ F⃜V⃜\nS̸͟͞Y̸͟͞N̸͟͞D̸͟͞I̸͟͞C̸͟͞A̸͟͞T̸͟͞E̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"sϒͷδῖͼαtϵ ῖkῠt✔️")
          ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
          ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"sϒͷδῖͼαtϵ ῖkῠt✔️")
          ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
          ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"sϒͷδῖͼαtϵ ῖkῠt✔️")
          ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
          ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"sϒͷδῖͼαtϵ ῖkῠt✔️")
          ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
          ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"sϒͷδῖͼαtϵ ῖkῠt✔️ LIKE status kakak 😘😘😘")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
                    ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by S̸͟͞Y̸͟͞N̸͟͞D̸͟͞I̸͟͞C̸͟͞A̸͟͞T̸͟͞E̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞\nStatus Boss udah Kami Like\nOwner Kami :\nA ChiqaLFV")
